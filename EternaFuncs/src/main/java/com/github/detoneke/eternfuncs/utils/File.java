package com.github.detoneke.eternfuncs.utils;
...
public class File extends YamlConfiguration {
    ...
    public File(Plugin plugin, String filename, String fileExtension, java.io.File folder){
        this.plugin = plugin;
    ...
    public File(Plugin plugin, String fileName, String fileExtension) {
